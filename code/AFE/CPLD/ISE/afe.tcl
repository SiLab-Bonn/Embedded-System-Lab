# 
# Project automation script for AFE 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source AFE.tcl), then you can
...
proc set_project_props {} {
   ...
   project set device "xc2c32a"
   project set package "QFG32"
   project set speed "-4"
...
proc set_process_props {} {
   ...
   project set "Target UCF File Name" "/home/ise/Xilinx/AFE/afe.ucf" -process "Lock Pins"
   ...
   project set "I/O Voltage Standard" "LVCMOS33" -process "Fit"
   ...
   #project set "Work Directory" "/home/ise/Xilinx/AFE/xst" -process "Synthesize - XST"
   project set "Work Directory" "temp" -process "Synthesize - XST"
